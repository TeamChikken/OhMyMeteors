...
public class Config {
    ...
    public static List<String> BIOME_SPAWN_LIST = List.of(Biomes.CHERRY_GROVE.location().toString(), Biomes.SOUL_SAND_VALLEY.location().toString(), "modname:modbiome");
    ...
    private static final List<String> BIOME_SPAWN_LIST_default =  List.of(Biomes.CHERRY_GROVE.location().toString(), Biomes.SOUL_SAND_VALLEY.location().toString(), "modname:modbiome");
