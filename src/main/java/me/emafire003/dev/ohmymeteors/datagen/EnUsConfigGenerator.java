...
public class EnUsConfigGenerator extends LanguageProvider {
    ...
    public void generateModTranslations(){
        ...
        add("flan.permision.ohmymeteors:allow_meteor_spawn", "Meteor spawning");
        add("flan.permision.ohmymeteors:allow_meteor_spawn.desc", "Allows meteors to spawn inside this claim");
        add("creativetab.ohmymeteors.ohmymeteors_tab", "OhMyMeteors Items");
    }

    @Override
    protected void addTranslations() {
        generateModTranslations();
        ConfigApiJava.buildTranslations(OMMConfigV2.class, ResourceLocation.fromNamespaceAndPath(OhMyMeteors.MOD_ID, "ohmymeteors_config"), "en_us", true, this::add);
